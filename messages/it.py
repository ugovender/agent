...
data={
    ...
    'copyRuntime': u'Copia runtime...', 
    'copyNative': u'Copia native...',
    ...
    'toExit':u'per uscire.',
    'install':u'Installa',
    'runWithoutInstallation':u'Esegui senza installare',
    ...
    'runWithoutInstallationConnected':u'La sessione è attiva.\nPer collegarsi a questo agente:\n\nVai su: https://www.dwservice.net\n\nUtente: {0}\n\nPassword: {1}\n\n',
    ...
    'configureInstallAgent':u'Come vuoi configurare l\'agente?',
    'configureInstallNewAgent':u'Creare un nuovo agente',
    'configureInstallCode':u'Inserire il codice di installazione',
