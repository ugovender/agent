...
data={
    ...
    'copyRuntime': u'Coping runtime...', 
    'copyNative': u'Coping native...',
    ...
    'toExit':u'to exit.',
    'install':u'Install',
    'runWithoutInstallation':u'Run once without installation',
    ...
    'runWithoutInstallationConnected':u'The session is active.\nTo connect to this agent:\n\nGo to: https://www.dwservice.net\n\nUser: {0}\n\nPassword: {1}\n\n',
    ...
    'configureInstallAgent':u'How you configure the agent?',
    'configureInstallNewAgent':u'Create a new agent',
